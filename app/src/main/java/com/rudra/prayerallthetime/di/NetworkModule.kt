...
object NetworkModule {
    ...
    @Provides
    @Singleton
    fun provideDuaApiService(): DuaApiService {
        return Retrofit.Builder()
            .baseUrl("https://api.alquran.cloud/v1/") // Placeholder, using Quran Cloud for consistency if they had it, or a real Dua API.
            .addConverterFactory(GsonConverterFactory.create())
            .build()
            .create(DuaApiService::class.java)
    }
